...
if ( ! function_exists( 'wp_basis_load_files' ) ) {
    ...
    wp_enqueue_style('main-styles', get_template_directory_uri() . '/main.css');
    wp_enqueue_style('style-styles', get_template_directory_uri() . '/style.css');
	...
	function register_popup_menu_location() {
    	register_nav_menu('popup-main-menu', __('Popup Main Menu'));
		register_nav_menu('popup-sub-menu', __('Popup Sub Menu'));
		register_nav_menu('popup-fixed-menu', __('Popup Fixed Menu'));
	}

	add_action('after_setup_theme', 'register_popup_menu_location');
}
